...
const AdminSidebar = () => {
  ...
  return (
    <>
      ...
      <aside
        className={`${toggle ? "w-0" : "w-72"} transition-all max-md:fixed sticky top-0 z-20  h-screen shrink-0 flex-col border-r border-slate-800 bg-slate-900 text-white overflow-hidden`}
      >
        {/* Header */}
